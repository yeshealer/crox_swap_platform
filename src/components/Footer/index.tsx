...
import { Menu as UikitMenu, Button, Toggle, useWalletModal, IconButton, useMatchBreakpoints } from 'crox-uikit2.0'
...
const Footer = (props) => {
  ...
  const token = "0x2c094F5A7D1146BB93850f629501eB749f6Ed491"
  ...
  return (
    <div className="wrapper" style={{ width: "100%" }}>
      <div style={{ display: "flex", alignItems: "center", marginBottom: 20 }}>
        ...
        <img src="/footer_logo.svg" alt="logo" style={{ width: "50px", marginLeft: "20px" }} />
        <img src="/Metamask.svg" alt="metamask" style={{ width: "20px", marginLeft: "20px" }} />
        <span style={{ fontSize: "12px", color: "white", marginLeft: "10px", cursor: 'pointer' }} onClick={addWatchToken}>Add $CROX to Metamask</span>
      </div>

      <div style={{ display: "flex", alignItems: "center", marginRight: "40px", marginBottom: 20 }}>
        <a href="https://t.me/croxswap">
          <img src="/icon_telegram.svg" alt="telegram" style={{ marginRight: "16px" }} />
        </a>
        <a href="https://twitter.com/croxswap">
          <img src="/icon_twitter.svg" alt="twitter" style={{ marginRight: "16px" }} />
        </a>
        <a href="https://github.com/croxswap">
          <img src="/icon_github.svg" alt="github" style={{ marginRight: "16px" }} />
        </a>
        <a href="https://www.youtube.com/channel/UCPEJ2aiaH03VwKe4YoFWSGw">
          <img src="/icon_youtube.svg" alt="youtube" style={{ marginRight: "16px" }} />
        </a>
        <a href="https://croxswap.medium.com">
          <img src="/icon_medium.svg" alt="blog" style={{ marginRight: "16px" }} />
        </a>
        <a href="https://reddit.com/r/croxswap">
          <img src="/icon_reddit.svg" alt="reddit" style={{ marginRight: "16px" }} />
        </a>
        {!isMd && !isSm && !isXs || (
          <span style={{ fontSize: 12, color: "white", padding: "10px", background: "#253253", marginRight: "20px", borderRadius: '8px' }}>$CROX:${croxPrice.toFixed(3)}</span>
        )}
      </div>
    </div>
  )
