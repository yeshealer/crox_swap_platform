          ...
          >
            <SwiperSlide>
              <div className={!isDark ? "partner_review_white" : "partner_review"}>
                ...
                <Text fontSize="14px" color={isDark ? "#0498AE" : "#00deff"} style={{textAlign: 'right'}}>--Thomas Butcher, COO, CentricSwap</Text>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className={!isDark ? "partner_review_white" : "partner_review"}>
                ...
                <Text fontSize="14px" color={isDark ? "#0498AE" : "#00deff"} style={{textAlign: 'right'}}>-- Senor Burdy, Founder & CEO, Rasta Finance</Text>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className={!isDark ? "partner_review_white" : "partner_review"}>
                ...
                <Text fontSize="14px" color={isDark ? "#0498AE" : "#00deff"} style={{textAlign: 'right'}}>-- Master Blaster, Bitcrush Arcade</Text>
              </div>
            </SwiperSlide>
          </Swiper>
        </div>
                ...
                <div>
                  <Accordion expanded={expanded === "panel1" ? true : false} onChange={handleChange('panel1')} className="accordion_top">
                    <AccordionSummary
                      ...
                      id="panel1bh-header"
                    >
                      <Typography sx={{ width: '100%', color: 'white', flexShrink: 0, fontSize: 14 }}>
                        About
                      </Typography>
                    </AccordionSummary>
                  ...
                  <Accordion expanded={expanded === "panel2" ? true : false} onChange={handleChange('panel2')} className="accordion_top">
                    <AccordionSummary
                      ...
                      id="panel2bh-header"
                    >
                      <Typography sx={{ width: '100%', color: 'white', flexShrink: 0, fontSize: 14 }}>Charts</Typography>
                    </AccordionSummary>
                    <AccordionDetails className="accordion_detail">
                  ...
                  <Accordion expanded={expanded === "panel4" ? true : false} onChange={handleChange('panel4')} className="accordion_top">
                    <AccordionSummary
                      ...
                      id="panel4bh-header"
                    >
                      <Typography sx={{ width: '100%', color: 'white', flexShrink: 0, fontSize: 14 }}>Products</Typography>
                    </AccordionSummary>
                    <AccordionDetails className="accordion_detail">
                  ...
                  <Accordion expanded={expanded === "panel5" ? true : false} onChange={handleChange('panel5')} className="accordion_top">
                    <AccordionSummary
                      ...
                      id="panel5bh-header"
                    >
                      <Typography sx={{ width: '100%', color: 'white', flexShrink: 0, fontSize: 14 }}>Innovation</Typography>
                    </AccordionSummary>
                    <AccordionDetails className="accordion_detail">
