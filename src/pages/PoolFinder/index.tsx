...
import { Button, ChevronDownIcon, AddIcon, CardBody, Text } from 'crox-uikit2.0'
...
export default function PoolFinder() {
  ...
  const prerequisiteMessage = (
    <LightCard padding="45px 10px">
      <Text style={{ textAlign: 'center' }} color={theme.colors.textSubtle}>
      ...
      <AppBody title="">
        ...
        <CardBody>
          <AutoColumn gap="md">
            ...
            <ColumnCenter>
              <AddIcon color="white" width="55px" style={{backgroundColor:"#0c7f92", borderRadius: "50%"}} />
            </ColumnCenter>
            ...
            {hasPosition && (
              <ColumnCenter
                style={{ justifyItems: 'center', backgroundColor: '', padding: '12px 0px', borderRadius: '12px', width: "auto", height: "auto", margin: "0"}}
              >
                <Text style={{ textAlign: 'center', color: "white" }}>Pool Found!</Text>
              </ColumnCenter>
            )}
                ...
                hasPosition && pair ? (
                  ...
                  <LightCard padding="45px 10px">
                    <AutoColumn gap="sm" justify="center">
                      <Text color={theme.colors.textSubtle} style={{ textAlign: 'center' }}>You don’t have liquidity in this pool yet.</Text>
                      <StyledInternalLink to={`/add/${currencyId(currency0)}/${currencyId(currency1)}`}>
                        <Text color={theme.colors.textSubtle} style={{ textAlign: 'center' }}>
