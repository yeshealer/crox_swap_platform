...
import { Button, CardBody, AddIcon, Text as UIKitText } from 'crox-uikit2.0'
  ...
  return (
    <>
      <AppBody title="AddLiquidity">
        ...
        <Wrapper>
          ...
          <CardBody>
            <AutoColumn gap="20px">
              {noLiquidity && (
                <ColumnCenter style={{width: "100%", padding: "0px", margin: "0px 0px 65px 0px"}}>
                  <Pane>
                    <AutoColumn gap="12px">
                      ...
                      <RowBetween>
                        {approvalA !== ApprovalState.APPROVED && (
                          <Button
                            ...
                            style={{ width: approvalB !== ApprovalState.APPROVED ? '48%' : '100%', borderRadius: "5px" }}
                          >
                            {approvalA === ApprovalState.PENDING ? (
                        ...
                        {approvalB !== ApprovalState.APPROVED && (
                          <Button
                            ...
                            style={{ width: approvalA !== ApprovalState.APPROVED ? '48%' : '100%', borderRadius: "5px" }}
                          >
                            {approvalB === ApprovalState.PENDING ? (
      ...
      {pair && !noLiquidity && pairState !== PairState.INVALID ? (
        <AutoColumn style={{ minWidth: '20rem', margin: '1rem 0rem' }}>
