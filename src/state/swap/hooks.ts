...
export function queryParametersToSwapState(parsedQs: ParsedQs): SwapState {
  ...
  inputCurrency = inputCurrency === '' ? 'ETH' : inputCurrency;
  outputCurrency = (outputCurrency === '' || outputCurrency === 'ETH') ? '0x2c094F5A7D1146BB93850f629501eB749f6Ed491' : outputCurrency;
